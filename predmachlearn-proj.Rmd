...
This is a writeup illustrating the application of machine learning (specifically 5-fold cross-validated random forests) to data from Velloso, et al. in order to predict activity type from sensor data.
